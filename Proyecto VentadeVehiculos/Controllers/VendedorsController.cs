...
namespace Proyecto_VentadeVehiculos.Controllers
{
    public class VendedorsController : Controller
    {
        ...
        public VendedorsController(Proyecto_VentadeVehiculosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdVendedor,Nombre,correo,fechanacimiento")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdVendedor,Nombre,correo,fechanacimiento")] Vendedor vendedor)
        {
